...
///
/// TODO(roadmap): Phase 2 (see ROADMAP.md) — this needs to operate
/// per-`Object` (apply its transform, slice in world space) and tag
/// output layers by object id so same-Z layers across objects can be
